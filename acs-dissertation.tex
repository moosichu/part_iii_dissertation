...
it with any C or GLSL counterpart is meaningless. % TODO(Rewrite)

\section{CUG versus raw C and GLSL}
...
For this reason, we compared the performance of CUG implementation of FishCopy
with the one written in C/GLSL. As expected, the C/GLSL implementation slightly
...
% TODO(Content!). READ AND ENSURE WE HAVE WHAT MYCROFT EXPECTS

% \section{Conclusion}

% TODO(Content!): WRITE EVALUATION CONCLUSION
