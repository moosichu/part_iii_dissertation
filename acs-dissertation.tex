...
I implemented a set of languages.
...
several reasons - both beyond and as a result of its legacy. The focus of
this is on the language-aspects of graphics programming.

The largest competitor to OpenGL has been
...
ensures the enforcement of interfaces between the two languages. The second is a
set of two novel toy languages which natively support such enforcement.
...
TODO: reference usage of FNV hash \cite{FNVHash}.
