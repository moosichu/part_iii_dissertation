...
written for the GPU and CPU. Section \ref{sec:api_challanges} fleshes out how
typical APIs used to control and program for GPUs work.

There has been research into pushing forward the state-of-the-art in targeting
more programmer-friendly ways. However, TODO:.
...
are written in C++, Python is also used as a build-system to enable easy
