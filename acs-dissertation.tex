...
\texttt{VkPipelineShaderStageCreateInfo} data structure instance. The relevant
part of identifying \texttt{main} using a string, similar to the example shown
in Listing \ref{lst:annotation_example_output}.
...
let compute_pipeline_create_info : C::VkPipelineShaderStageCreateInfo = {
