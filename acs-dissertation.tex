...
one vendor but not on GPUs from the other \cite{TODO}.

Section \ref{sec:api_options} gives an extensive breakdown of what is
summarised here.
...
most use-cases involving GPUs. The main reason for this
