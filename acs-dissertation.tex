...
present. Section TODO explains how historically compiling custom langauges to
...
% TODO: Read https://www.khronos.org/registry/spir-v/specs/1.0/SPIRV.pdf

Listing \ref{lst:language_example} shows the same snippet of code as the
annotation example shown in Listin \ref{lst:annotation_example_input}.
...
\begin{itemize}
    ...
    \cite{GLFuzz}. %TODO: maybe include an image of this
...
enjoy today. %TODO cite unity presentation slide.
...
TODO: List those sources, and provide a reference to a complete summary of
them.
...
The reason this has not been previously possible, is because of TODO: find
...
\begin{itemize}
    ...
    use cases described here are applicable to a wide audience (TODO: phrase
    better).
...
TODO: Describe shader language.

\subsection{Cross-Language type system}

TODO: Describe the cross-langauge type system.
