...
% TODO(Content!): Give influences, overall design, etc.
...
However, the syntax has been influenced by Swift, and one key feature we do
provide is the distinction. \textit{nullable}


Design decisions made which are not directly related to the problem this paper
...
TODO(Content!): No arrays, no operator precedence, have to manually-ensure
external C definitions are correct.
...
\subsection{CUG-min and the cross-dialect type system}
...
The combined source-code for both projects comes to around 13,000 lines of
code. 12,000 of which are for the CUG compiler alone.
